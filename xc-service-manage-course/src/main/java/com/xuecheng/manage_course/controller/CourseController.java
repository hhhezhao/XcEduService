...
public class CourseController extends BaseController implements CourseControllerApi{
    ...
    public AddCourseResult addCourseBase(@RequestBody CourseBase courseBase) {
        ...
        String companyId = userJwt.getCompanyId();
        return courseService.addCourseBase(companyId,courseBase);
    }
    ...
    //@PreAuthorize("hasAuthority('course_find_pic')")  // 当用户拥有course_find_list权限时才能访问此方法
    @Override
    ...
    //@PreAuthorize("hasAuthority('course_find_courseview')")
    @Override
